export default function FloatingWhatsAppButton() {
  return (
    <a
      ...
      className="yg-whatsapp-fab fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition hover:scale-105"
    >
