...
const GUIDE_COLUMNS =
  "adresse, photo_url, checkin_heure, checkout_heure, consignes_arrivee, code_acces, wifi_nom, wifi_code, parking_info, parking_photo_url, equipements, equipements_photo_url, regles_maison, recommandations, contact_urgence";
