...
const GUIDE_COLUMNS =
  "adresse, ville, photo_url, brand_logo_url, brand_color, checkin_heure, checkout_heure, instructions_arrivee, code_acces, wifi_nom, wifi_code, parking_info, parking_photo_url, equipements, equipements_photo_url, regles_maison, recommandations, contact_urgence";
